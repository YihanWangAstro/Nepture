...
void job(std::string job_name, size_t thread_id, size_t scattering_num) {
    ...
    std::fstream post_flyby_file5("off-5-" + job_name + "-" + std::to_string(thread_id) + ".txt", std::ios::out);
    std::fstream post_flyby_file6("off-6-" + job_name + "-" + std::to_string(thread_id) + ".txt", std::ios::out);
    std::fstream post_flyby_file7("off-7-" + job_name + "-" + std::to_string(thread_id) + ".txt", std::ios::out);
    std::fstream post_flyby_file8("off-8-" + job_name + "-" + std::to_string(thread_id) + ".txt", std::ios::out);
